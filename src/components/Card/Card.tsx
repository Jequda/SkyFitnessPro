...
export default function Card({ isProfilePage, handleOpenPopSelectTraining, handleDeleteCard }: CardProps) {
    ...
    return (
        <div className="w-[360px] flex flex-col justify-center items-center gap-[24px] rounded-[30px] shadow-lg">
            <div className="flex flex-row-reverse w-[360px]">
                <svg className="absolute pt-[20px] pr-[20px] w-[56px] h-[56px]" width="56" height="56" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleDeleteCard}>
                ...
                <img alt="изображение курса" className="rounded-[30px] w-[360px] h-[325px]" src="yoga.png" />
            </div>
