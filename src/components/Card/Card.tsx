...
export default function Card({ isProfilePage, handleOpenPopSelectTraining }: CardProps) {
    ...
    return (
        <div className="w-[360px] flex flex-col justify-center items-center gap-[24px] rounded-[30px] shadow-lg">
            ...
            {isProfilePage && (
                <div className="mb-[40px] w-full h-[100px] bg-white rounded-b-[30px] flex flex-col justify-between items-center px-[30px]">
                    <div className="flex justify-between items-center w-full">
                        <div className="text-base leading-[18px] font-normal">Прогресс 50%</div>
                    </div>
                    <div className="w-[300px] h-[10px] bg-gray-300 rounded-full mt-[10px]">
