        ...
        <div className="flex flex-col justify-center items-center gap-[50px] px-[140px] pb-[81px] font-roboto">
            <div className="flex justify-center items-center gap-[20px]">
                ...
                <div className="flex flex-col items-center">
                    <div className="flex bg-lime px-[16px] py-[20px] gap-[10px] text-[32px] leading-[35px] font-normal">Измени своё <br /> тело за полгода!</div>
            ...
            <div className="flex gap-[40px] flex-wrap justify-start max-w-[1160px]">
                <Card />
                <Card />
                <Card />
            </div>
